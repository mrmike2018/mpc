...
//MPC_Player::MPC_Player(int playerID): thisPlayerID(playerID) {
...
int MPC_Player::initializePlayerData() {
	...
	myShareOfS1 = 0;    // later remove this variable, mySharesOfDifferentSecrets would have this value
	myShareOfS2 = 0;    // later remove this variable, mySharesOfDifferentSecrets would have this value
	myShareOfS1plusS2 = 0;
